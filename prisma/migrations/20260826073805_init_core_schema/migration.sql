...
-- CreateEnum
CREATE TYPE "SubscriptionPlan" AS ENUM ('STARTER', 'PROFESSIONAL', 'PREMIUM');
...
-- CreateIndex
CREATE INDEX "bookings_staffMemberId_idx" ON "bookings"("staffMemberId");
...
-- AddForeignKey
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_staffMemberId_fkey" FOREIGN KEY ("staffMemberId") REFERENCES "staff_members"("id") ON DELETE SET NULL ON UPDATE CASCADE;
