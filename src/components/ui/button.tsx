...
export function Button({ variant = "primary", className = "", ...props }: ButtonProps) {
  const base =
    "inline-flex items-center justify-center rounded-md text-sm font-semibold h-10 px-5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#795831] disabled:opacity-50 disabled:pointer-events-none";
  const variants = {
    primary: "bg-[#795831] text-white hover:bg-[#5F4426] shadow-sm",
