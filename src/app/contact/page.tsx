        ...
        <section className="px-6 lg:px-12 pb-16 max-w-[1200px] mx-auto">
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <div className="flex flex-col gap-6">
              <div className="rounded-2xl border border-[#E5DDD0] bg-white p-6 space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#1F1E1D]">{t("contact.email")}</p>
                    <a
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#1F1E1D]">{t("contact.phone")}</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#1F1E1D]">{t("contact.location")}</p>
                    <p className="text-sm text-[#4A4640]">{t("contact.locationValue")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#F7F3ED] text-[#795831]">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#1F1E1D]">{t("contact.response")}</p>
                    <p className="text-sm text-[#4A4640]">{t("contact.responseValue")}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-[#E5DDD0] bg-white p-6 lg:p-8">
              <h2 className="text-lg font-semibold text-[#1F1E1D]">{t("contact.formTitle")}</h2>
